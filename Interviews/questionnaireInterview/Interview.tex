...
\begin{center}
  \textbf{\huge Interatives Projektor-Kamerea-System \vskip0.2em Interview}
\end{center}\vskip1em
...
\Qitem{\Qq{Wie soll das KPS ein/ausgeschaltet werden?}
  \begin{Qlist2}
  \item Nie
  \item Schalter an der Box
  \item Menüpunkt
  \item Klatschen/Clapper
  \item Fehrnbedienung
  \item Sonstige: \Qline{4cm}
  \end{Qlist2}
}


\Qitem{\Qq{Sollte das PKS ein Display oder LED für Zusatzinformationen haben?}  
\begin{Qlist}
\item Ja, folgende:\Qtab{2.5cm}{ \Qline{13cm}}
\item Nein, weil:\Qtab{2.5cm}{ \Qline{13cm}}
\end{Qlist}
}

\Qitem{\Qq{Sollte das PKS in sich beweglich sein?}
\begin{Qlist}
\item Ja, weil:\Qtab{2.5cm}{ \Qline{13cm}}
\item Automatisch:\Qtab{2.5cm}{ \Qline{13cm}}
\item Manuel (Schwanenhals):\Qtab{4cm}{ \Qline{11.5cm}}
\item Nein, weil:\Qtab{2.5cm}{ \Qline{13cm}}
\end{Qlist}
}

\Qitem{\Qq{Sollte das PKS mobil (Batteriebetrieben) sein?}
\begin{Qlist}
\item Ja, weil:\Qtab{2.5cm}{ \Qline{13cm}}
\item Nein, weil:\Qtab{2.5cm}{ \Qline{13cm}}
...
\Qitem{\Qq{Wie würde ein neues dynamisches Interface erzeugt werden?}
\begin{Qlist2}
\item Geste
\item Klick
\end{Qlist2}
...
\Qitem{\Qq{Sollten mehrere PKS für ein Interface kombinierbar sein}
\Qlines{1}
}


\Qitem{
\Qq{Ist es vorstellbar mehre Teile zu platzieren um System effizient zu nutzten}
\Qlines{1}
}

\Qitem{\Qq{Wie hoch darf dürfte der Konfigurationsaufwand sein (Fokussierung)?}
\Qlines{1}
}

\Qitem{\Qq{Was hältst du von Größe und Gewicht?}
\Qlines{1}
}



\Qitem{\Qq{Weitere Ideen und Anmerkungen:}
\Qlines{5}
}
